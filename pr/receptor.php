<?php
$baseUrl = 'https://proyectocafeteriaeltio.000webhostapp.com/pr';
...
$pdt_identity_token = 'GHqWj5Y1cHUeGNKnHP4hwnXrHanWPjcBkPpnOxZ_Iisr4xzqsPx4zOB3Y5m';
...
curl_setopt($request, CURLOPT_URL, "https://www.sandbox.paypal.com/cgi-bin/webscr");
...
curl_setopt($request, CURLOPT_HTTPHEADER, array("Host: $paypal_hostname",'Connection: Close', 'User-Agent: mycompany'));
...
if (strcmp($lines[0], "SUCCESS") == 0) {
    ...
    Recibimos $mc_gross Pesos en concepto de: $quantity $item_name.<hr>
