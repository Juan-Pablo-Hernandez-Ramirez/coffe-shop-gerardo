...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="form_pay">
    ...
    <!-- Valores requeridos -->
    <input type="hidden" name="business" value="sb-oefn626042757@business.example.com">
    ...
    <input type="hidden" name="image_url" value="https://proyectocafeteriaeltio.000webhostapp.com/assets/images/logo/logo-home.jpg">
